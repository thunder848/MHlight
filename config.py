...
from DCoLight_agent import DCoLightAgent
from Hmasac_agent import HMaSACAgent
#from difsac_agent import HMaSACAgent
from Hmappo_agent import HMaPPOAgent
from MASACGraph import MASACGraphAgent
from MAPPOGraph import MAPPOGraphAgent
...
DIC_EXP_CONF = {
    ...
    "LIST_MODEL_NEED_TO_UPDATE":
        ["Deeplight", "SimpleDQN", "CoLight","GCN", "SimpleDQNOne","Lit","Hmasac","MASACGraph","MAPPOGraph","Hmappo"],
    "MODEL_POOL": False,
    "NUM_BEST_MODEL": 3,
    "PRETRAIN": True,
...
DIC_AGENTS = {
    ...
    'Hmasac':HMaSACAgent,
    'MASACGraph':MASACGraphAgent,
    'MAPPOGraph':MAPPOGraphAgent,
    'Hmappo':HMaPPOAgent
}
